            ...
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  checked={state.ratings === "4STARTABOVE" || false}
                />
                <label
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  checked={state.ratings === "3STARTABOVE" || false}
                />
                <label
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  checked={state.ratings === "2STARTABOVE" || false}
                />
                <label
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  checked={state.ratings === "1STARTABOVE" || false}
                />
                <label
