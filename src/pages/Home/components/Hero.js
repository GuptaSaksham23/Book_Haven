  ...
  return (
    <section className="flex flex-col lg:flex-row dark:text-slate-100 items-center">
      <div className="text my-5">
        <h1 className="text-5xl font-bold">The Ultimate Book Store</h1>
        <p className="text-2xl my-7 px-1 dark:text-slate-300">
          BookHaven is the world's most popular and authoritative source for
          computer science books. Find ratings and access to the newest books
          digitally.
        </p>
        <Link
          to="/products"
